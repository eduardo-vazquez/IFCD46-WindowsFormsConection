...
namespace WindowsFormsConection
{
	...
	public partial class DataEduardoEmployeesDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void Deleteregions(regions instance);
		...
		public DataEduardoEmployeesDataContext() : 
				base(global::WindowsFormsConection.Properties.Settings.Default.EduardoEmployeesConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public DataEduardoEmployeesDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public DataEduardoEmployeesDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public DataEduardoEmployeesDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public DataEduardoEmployeesDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
	...
	public partial class SALAS : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _Pelicula;
    ...
    partial void OnPeliculaChanging(System.Nullable<int> value);
    partial void OnPeliculaChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Pelicula", DbType="Int")]
		public System.Nullable<int> Pelicula
		{
			get
			{
			...
			set
			{
				if ((this._Pelicula != value))
				{
					if (this._PELICULAS.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnPeliculaChanging(value);
					this.SendPropertyChanging();
					this._Pelicula = value;
					this.SendPropertyChanged("Pelicula");
					this.OnPeliculaChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="PELICULAS_SALAS", Storage="_PELICULAS", ThisKey="Pelicula", OtherKey="Codigo", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._PELICULAS.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((value != null))
					{
						...
						this._Pelicula = value.Codigo;
					}
					else
					{
						this._Pelicula = default(Nullable<int>);
					}
	...
	public partial class PELICULAS : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _CalificacionEdad;
    ...
    partial void OnNombreChanging(string value);
    partial void OnNombreChanged();
    partial void OnCalificacionEdadChanging(System.Nullable<int> value);
    partial void OnCalificacionEdadChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_CalificacionEdad", DbType="Int")]
		public System.Nullable<int> CalificacionEdad
		{
			get
			{
				return this._CalificacionEdad;
			}
			set
			{
				if ((this._CalificacionEdad != value))
				{
					this.OnCalificacionEdadChanging(value);
					this.SendPropertyChanging();
					this._CalificacionEdad = value;
					this.SendPropertyChanged("CalificacionEdad");
					this.OnCalificacionEdadChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="PELICULAS_SALAS", Storage="_SALAS", ThisKey="Codigo", OtherKey="Pelicula")]
